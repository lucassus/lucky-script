# Capability: Compound Assignment

## Purpose

Compound assignment operators (`+=`, `-=`, `*=`, `/=`) provide syntactic sugar for common update patterns, reducing repetition and improving readability. They desugar at parse time into equivalent simple assignment expressions, ensuring consistent behavior with the existing scoping rules for `local`, `outer`, and bare assignment.
